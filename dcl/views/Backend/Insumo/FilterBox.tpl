		        ...
		        <table border="0" cellspacing="0">
				  <tr height="50">
	        		...
	        		<table width=""  border="0" cellspacing="0">
					  ...
					  <tr>
					    <td><input type="text" value="{if $OrdenDeTrabajoId}{$OrdenDeTrabajoId}{else}Nro de orden{/if}" name="filters[OrdenDeTrabajoId]" id="OrdenDeTrabajoId"/></td>
					  </tr>
					</table>
	        		...
	        		<table width=""  border="0" cellspacing="0">
					  <tr>
					    <td rowspan="2">  <img src="/images/icons/editPerfilModify.png" /></td>
					    <td><input type="text" value="{if $ClienteNombre}{$ClienteNombre}{else}Nombre cliente{/if}" name="filters[NombreCliente]" id="NombreCliente"/></td>
					  </tr>
					  <tr>
					    <td></td>
					  </tr>
