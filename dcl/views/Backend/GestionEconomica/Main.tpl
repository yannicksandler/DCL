		...
		<td width="299" valign="top" style="width:224.5pt;border:solid windowtext 1.0pt;   border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;   padding:0cm 5.4pt 0cm 5.4pt">
			...
			<table border="1">
				...
				<td>
						...
						<br><span id="ValorEfectivoMain">$ {$Efectivo}</span>
						</p>
						<input id="saldoefectivo" type="hidden" value="{$Efectivo}"></>
				...
				<td>
						...
						<br><span>$ {$ChequesB} (B)</span>
						<br><span>$ {$ChequesN} (N)</span>
						</p>
				...
				<br><span>$ {$PendienteAcreditar}</span>
				</p>
				...
				<td>
                		<p  style="font-family:Arial; color:black; font-size: 11pt; mso-ansi-language:ES">Bancos: <br><span>$ {$SaldoBancos}</span></p>
                		<a class="ajax" id=""
		...
		<td width="299" valign="top" style="width:224.5pt;border-top:none;border-left:   none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;   mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;   mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt">
		    ...
		    <table border="1">
				...
				<td>
						...
						<p style="font-family:Arial; color:black; font-size: 11pt; mso-ansi-language:ES">Cuentas por cobrar de clientes <br><span>$ {$SaldoTotalClientes}</span></p>
				...
				<tr>
				<td>
                		<p style="font-family:Arial; color:black; font-size: 11pt; mso-ansi-language:ES">Deuda total a proveedores <br><span>$ {$SaldoTotalProveedores}</span></p>
	 ...
	 --> 
		...
		<div class="filtersBox filtersInfoBox">
                <ul>
                	...
                	<li>
                		<p title="Ordenes de trabajo pendientes de facturar">Pendiente de facturar: <br><span>$ {$ImportePendienteDeFacturar}</span></p>
                		<a class="ajax" id=""
                	...
                	<li>
                		...
                		<br><span>$ {$TotalOrdenesDeCompraPendientesDePagoBlanco} (B)</span>
                		<br><span>$ {$TotalOrdenesDeCompraPendientesDePagoNegro} (N)</span>
                		</p>
                		<a class="ajax" id=""
                	...
                	<li>
                		...
                		<br><span>$ {$PrevisionesBlanco} (B)</span>
                		<br><span>$ {$PrevisionesNegro} (N)</span>
                		</p>
                		<a class="ajax" id=""
         ...
         {/if} <!-- end / solo mostrar totales a Perfil Administrador -->
