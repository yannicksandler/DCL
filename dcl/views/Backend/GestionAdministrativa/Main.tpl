                ...
                <ul>
                	...
                	<li>
                		...
                		<select name="" class="required CambiarProveedor" id="SeleccionarProveedor" style="display:none">
	                        ...
	                        <option value="{$p.Id}" {if ($p.Id eq $ProveedorId) }selected="selected"{/if}>{$p.Nombre}</option>
	                        {/foreach}
	                    </select>
                	</li>
                	<li>
        ...
        <div class="filtersBox filtersInfoBox"> 
			...
			<a class="ajax" id=""
             ...
             <div class="sectionMenu" id="ResumeTabs">
                	...
                	<a id="TabCobranzasPendientes" href="/GestionAdministrativa/CobranzasPendientes" title=""><span>Cobranzas pendientes{if $PendienteDeCobro} ({$PendienteDeCobro}){/if}</span></a>
                    
					<a id="TabPagosPendientes" href="/GestionAdministrativa/PagosPendientes" title=""><span>Pagos pendientes{if $PagosPendientes} ({$PagosPendientes}){/if}</span></a>
					
                    <a id="TabFacturacionPendiente" href="/GestionAdministrativa/FacturacionPendiente" title=""><span>Facturacion pendiente{if $PendienteDeFacturar} ({$PendienteDeFacturar}){/if}</span></a>
                    
                    <a id="TabChequesEnCartera" href="/GestionEconomica/ChequesTerceros" title=""><span>Cheques cartera ({$CantidadChequesCartera})</span></a>
                    
                    <a id="TabChequesPendientesAcreditar" href="/GestionEconomica/ChequesPendientesAcreditar" title=""><span>Cheques a acreditar ({$CantidadPendientesAcreditar})</span></a>
                    
                    <a id="TabChequesPendientesDebitar" href="/GestionEconomica/ChequesPendientesDebitar" title=""><span>Cheques a debitar ({$CantidadPendientesDebitar})</span></a>
                    <!-- 
