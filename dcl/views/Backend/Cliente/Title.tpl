                ...
                <div>
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td width="10%"><a href="/{$varController}/{$varAction}/pagesize/{$list.pageSize}/page/{$list.page}/order/Id_{if $order eq 'DESC'}ASC{else}DESC{/if}{if $search}/search/{$search}{/if}" class="{if $orderBy eq 'Id'}{if $order eq 'ASC'}orderUp{else}orderDown{/if}{else}orderNone{/if}" title="Numero">Numero</a></td>
                            ...
                            <td width="10%"><a href="/{$varController}/{$varAction}/pagesize/{$list.pageSize}/page/{$list.page}/order/Localidad_{if $order eq 'DESC'}ASC{else}DESC{/if}{if $search}/search/{$search}{/if}" class="{if $orderBy eq 'Localidad'}{if $order eq 'ASC'}orderUp{else}orderDown{/if}{else}orderNone{/if}" title="Localidad">Localidad</a></td>
                            <td width="10%"><a href="/{$varController}/{$varAction}/pagesize/{$list.pageSize}/page/{$list.page}/order/Direccion_{if $order eq 'DESC'}ASC{else}DESC{/if}{if $search}/search/{$search}{/if}" class="{if $orderBy eq 'Direccion'}{if $order eq 'ASC'}orderUp{else}orderDown{/if}{else}orderNone{/if}" title="Direccion">Direccion</a></td>
