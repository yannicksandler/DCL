				  ...
				  <tr height="50">
				    <td>
		                    ...
		                    <table width=""  border="0" cellspacing="0">
							  <tr>
							    ...
							    <td><input type="text" value="{if $FechaDesde}{$FechaDesde}{else}Fecha desde{/if}" name="filters[FechaDesde]" id="FechaDesde"/></td>
							  </tr>
							  <tr>
							    <td><input type="text" value="{if $FechaHasta}{$FechaHasta}{else}Fecha hasta{/if}" name="filters[FechaHasta]" id="FechaHasta"/></td>
							  </tr>
							</table>
	        		...
	        		<table width=""  border="0" cellspacing="0">
					  <tr>
					    ...
					    <td><input type="text" value="{if $ProveedorNombre}{$ProveedorNombre}{else}Nombre proveedor{/if}" name="filters[NombreProveedor]" id="NombreProveedor"/></td>
					  </tr>
					  <tr>
					    <td><input type="text" value="{if $FacturaId}{$FacturaId}{else}Nro de factura{/if}" name="filters[Numero]" id="FacturaId"/></td>
					  </tr>
					</table>
	                ...
	                <table width=""  border="0" cellspacing="0">
					  ...
					  <tr>
					    <td align="center">
					    	<input class="check" id="TipoA" type="radio" name="filters[FacturaTipo]" value="A" {if $FacturaTipo == 'A'}checked="checked"{/if}/>
		                    <label class="check blue">A</label>
		                    <input class="check" id="TipoB" type="radio" name="filters[FacturaTipo]" value="B" {if $FacturaTipo == 'B'}checked="checked"{/if}/>
		                    <label class="check blue">B</label>
		                    <input class="check" id="TipoN" type="radio" name="filters[FacturaTipo]" value="N" {if $FacturaTipo == 'N'}checked="checked"{/if}/>
