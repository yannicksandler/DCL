    ...
    <table width=""  border="0" cellspacing="0">
	  ...
	  <tr>
	    <td>
	    	<tr>
			  	<td align="center">
				                    <input class="check" id="TipoB" type="radio" name="filters[Tipo]" value="B" {if $Tipo == 'B'}checked="checked"{/if}/>
				                    <label class="check blue">B</label>
				                    <input class="check" id="TipoN" type="radio" name="filters[Tipo]" value="N" {if $Tipo == 'N'}checked="checked"{/if}/>
