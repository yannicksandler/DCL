...
<body class="popupLayout">
	...
	<div class="lightbox" id="FileLightbox" style="display:block;">
		...
		<div class="filtersBox filtersInfoBox">
                ...
                <ul>
                    <li>
                    	<p>Numero: <span>{$NotaDebito.Numero}</span></p>
                        <p>Fecha: <span>{$NotaDebito.Fecha}</span></p>
                        
						
                    </li>
                    <li>
						<p>Cliente: <span>{$NotaDebito.Cliente.RazonSocial}</span></p>
                    </li>
                </ul>
            </div> <!-- /filtersBox-->
	    
	    <div class="lightobxMain">
	    		<h2>{$NotaDebito.Comentario}</h2>
				<h1><br><br>Total: $ {$NotaDebito.Importe}</h1>
