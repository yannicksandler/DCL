                ...
                <div>
                    <table border="0" cellpadding="0" cellspacing="0">
							<tr>    
                                ...
                                <!--  -->
                                <td width="15%"><p>Precio s/IVA</p> </td>
                                <td width="10%"><p>Cantidad</p> </td>
                                <td width="15%"><p>Cond. pago</p> </td>
                    ...
                    <div class="listItems">
						...
						{foreach from=$Insumos item="d"}
						    <tr {$className}>
                                ...
                                <td width="15%">{$d.PrecioUnitarioSinIVA} 
                                ...
                                <td width="15%">{$d.CondicionDePago}</td>
                    ...
                    <div class="listItems">
                        ...
                        {if $Fletes|@count}
						    ...
						    <tr {$className}>
                                ...
                                <td width="15%">{$record.PrecioUnitarioSinIVA} 
                                ...
                                <td width="15%">{$record.CondicionDePago} </td>
                    ...
                    <div class="listItems">
                        ...
                        {if $ManoDeObra|@count}
						    ...
						    <tr {$className}>
                                ...
                                <td width="15%">{$mano.PrecioUnitarioSinIVA} 
                                ...
                                <td width="15%">{$mano.CondicionDePago} </td>
                    ...
                    <div class="listItems">
                        ...
                        {if $Comercializaciones|@count}
						    ...
						    <tr {$className}>
                                ...
                                <td width="15%">{$com.PrecioUnitarioSinIVA} 
                                ...
                                <td width="15%">{$com.CondicionDePago} </td>
