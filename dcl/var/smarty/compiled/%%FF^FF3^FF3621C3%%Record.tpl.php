<?php /* Smarty version 2.6.26, created on 2014-09-19 10:34:43
         compiled from Backend/Orden/Record.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'Backend/Orden/Record.tpl', 5, false),)), $this); ?>
                    <!-- item -->
...
" <?php if ($this->_tpl_vars['p']['Id'] == $this->_tpl_vars['record']['PrioridadId']): ?>selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['p']['Nombre']; ?>
                        ...
                        <td width="12%">
                        	<a class="Descripcion" title="<?php echo $this->_tpl_vars['record']['DescripcionDeTrabajo']; ?>
" href="/<?php echo $this->_tpl_vars['varController']; ?>
/Edit/id/<?php echo $this->_tpl_vars['record']['Id']; ?>
"><?php echo ((is_array($_tmp=$this->_tpl_vars['record']['DescripcionDeTrabajo'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall') : smarty_modifier_escape($_tmp, 'htmlall')); ?>
</a>
                        </td>
                        
                        <td width="8%" align="center">
                            <input type="button" class="btEdit" title="Editar orden de trabajo" onclick="location.href = '/<?php echo $this->_tpl_vars['varController']; ?>
/Edit/id/<?php echo $this->_tpl_vars['record']['Id']; ?>
';" />
