<?php /* Smarty version 2.6.26, created on 2014-09-11 12:54:36
         compiled from Backend/Cobranza/FacturasPendientesDeCobro.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'Backend/Cobranza/FacturasPendientesDeCobro.tpl', 176, false),)), $this); ?>
<?php echo '
...
?>
						<tr>
							...
							<td width="15%">
								<p class="">
										$ <?php echo $this->_tpl_vars['pendiente']['ImportePendienteDeCobro']; ?>
							...
							<td width="20%" align="center">
								    <input type="text" value="<?php echo $this->_tpl_vars['pendiente']['ImporteLiquidadoEnCobranza']; ?>
" name="ImporteItem" id="importe_<?php echo $this->_tpl_vars['pendiente']['Id']; ?>
" tipoivaid="<?php echo $this->_tpl_vars['pendiente']['TipoIvaId']; ?>
" class="importe"/>
								    <a class="AgregarFactura" id="<?php echo $this->_tpl_vars['pendiente']['Id']; ?>
"
