<?php /* Smarty version 2.6.26, created on 2014-09-19 10:34:42
         compiled from Backend/Orden/Title.tpl */ ?>
            <div class="listTop">
                <div>
...
<?php endif; ?>" class="<?php if ($this->_tpl_vars['orderBy'] == 'Producto'): ?><?php if ($this->_tpl_vars['order'] == 'ASC'): ?>orderUp<?php else: ?>orderDown<?php endif; ?><?php else: ?>orderNone<?php endif; ?>" title="Producto">Producto</a></td>
                            <td width="10%"><a href="/<?php echo $this->_tpl_vars['varController']; ?>
/<?php echo $this->_tpl_vars['varAction']; ?>
/<?php if ($this->_tpl_vars['OrdenEstadoId'] >= 0): ?>EstadoOrdenTrabajoId/<?php echo $this->_tpl_vars['OrdenEstadoId']; ?>
/<?php endif; ?><?php if ($this->_tpl_vars['NombreCliente']): ?>NombreCliente/<?php echo $this->_tpl_vars['NombreCliente']; ?>
...
<?php endif; ?>" class="<?php if ($this->_tpl_vars['orderBy'] == 'o.Cliente.Nombre'): ?><?php if ($this->_tpl_vars['order'] == 'ASC'): ?>orderUp<?php else: ?>orderDown<?php endif; ?><?php else: ?>orderNone<?php endif; ?>" title="Nombre cliente">Nombre cliente</a></td>
                            <td width="10%"><a href="/<?php echo $this->_tpl_vars['varController']; ?>
/<?php echo $this->_tpl_vars['varAction']; ?>
/<?php if ($this->_tpl_vars['OrdenEstadoId'] >= 0): ?>EstadoOrdenTrabajoId/<?php echo $this->_tpl_vars['OrdenEstadoId']; ?>
/<?php endif; ?><?php if ($this->_tpl_vars['NombreCliente']): ?>NombreCliente/<?php echo $this->_tpl_vars['NombreCliente']; ?>
...
<?php endif; ?>" class="<?php if ($this->_tpl_vars['orderBy'] == 'o.Estado.Nombre'): ?><?php if ($this->_tpl_vars['order'] == 'ASC'): ?>orderUp<?php else: ?>orderDown<?php endif; ?><?php else: ?>orderNone<?php endif; ?>" title="Estado">Estado</a></td>
...
<?php endif; ?>" class="<?php if ($this->_tpl_vars['orderBy'] == 'o.DiasProximoCambioEstado'): ?><?php if ($this->_tpl_vars['order'] == 'ASC'): ?>orderUp<?php else: ?>orderDown<?php endif; ?><?php else: ?>orderNone<?php endif; ?>" title="Dias para proximo cambio de estado">Proximo cambio</p></td>
...
/page/<?php echo $this->_tpl_vars['list']['page']; ?>
/order/o.Estado.Nombre_<?php if ($this->_tpl_vars['order'] == 'DESC'): ?>ASC<?php else: ?>DESC<?php endif; ?><?php if ($this->_tpl_vars['search']): ?>/search/<?php echo $this->_tpl_vars['search']; ?>
<?php endif; ?>" class="<?php if ($this->_tpl_vars['orderBy'] == 'o.Estado.Nombre'): ?><?php if ($this->_tpl_vars['order'] == 'ASC'): ?>orderUp<?php else: ?>orderDown<?php endif; ?><?php else: ?>orderNone<?php endif; ?>" title="Dias para finalizar">Finalizacion</p></td>
                            <td width="10%"><a href="/<?php echo $this->_tpl_vars['varController']; ?>
/<?php echo $this->_tpl_vars['varAction']; ?>
/<?php if ($this->_tpl_vars['OrdenEstadoId'] >= 0): ?>EstadoOrdenTrabajoId/<?php echo $this->_tpl_vars['OrdenEstadoId']; ?>
/<?php endif; ?><?php if ($this->_tpl_vars['NombreCliente']): ?>NombreCliente/<?php echo $this->_tpl_vars['NombreCliente']; ?>
...
<?php endif; ?>" class="<?php if ($this->_tpl_vars['orderBy'] == 'PrioridadId'): ?><?php if ($this->_tpl_vars['order'] == 'ASC'): ?>orderUp<?php else: ?>orderDown<?php endif; ?><?php else: ?>orderNone<?php endif; ?>" title="Prioridad">Prioridad</a></td>
...
<?php endif; ?>" class="<?php if ($this->_tpl_vars['orderBy'] == 'DescripcionDeTrabajo'): ?><?php if ($this->_tpl_vars['order'] == 'ASC'): ?>orderUp<?php else: ?>orderDown<?php endif; ?><?php else: ?>orderNone<?php endif; ?>" title="Descripcion">Descripcion</a></td>
