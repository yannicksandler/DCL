282
a:4:{s:8:"template";a:4:{s:25:"Backend/Cobranza/Edit.tpl";b:1;s:31:"Backend/Cobranza/ColumnForm.tpl";b:1;s:39:"Backend/Cobranza/FacturasLiquidadas.tpl";b:1;s:29:"Backend/Cobranza/GetPagos.tpl";b:1;}s:9:"timestamp";i:1410985693;s:7:"expires";i:1410985693;s:13:"cache_serials";a:0:{}}
<!-- date picker -->
...
<h1>Editar cobranza &raquo; <span>199 (Interno 221)</span></h1>

		        
         <input type="reset" value="Imprimir" id="221" class="btDark Print" title="Imprimir" />
        

<form id="FrmEdit" enctype="multipart/form-data" action="" method="post">
    <input type="hidden" id="CobranzaId" name="data[Id]" value="221" />
            ...
            <div class="productsEditorContent">
                ...
                <ul>
                    ...
                    <li>
							...
							<input type="hidden" class="required number" readonly="readonly" disabled id="ImporteTotalLiquidadoInput" name="data[ImporteLiquidado]" value="278942.51">
							
							<div id="ImporteTotalLiquidado"><label>$ 278942.51</label></div>
	                    </li>
	                    <li>
	                	    <label class="blue"><img src="/images/icons/money.png" title="Importe "/> Importe pagado</label>       
							 
							<input type="hidden" class="required number" readonly="readonly" disabled id="ImporteTotalPagadoInput" name="data[ImportePagado]" value="278942.51">
                    	...
                    	<li>
							...
							<div id="saldo"><label>-1452.00</label></div>
...
<h2>Total del cobro: $ 278942.51</h2>
<input type="hidden" id="TotalPago" name="" value="278942.51" />
	<div class="list">
                    ...
                    <div class="listItems">
                    	<table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <td width="10%">
												    ...
												    <tr >
                                <td width="10%">Retencion IIBB Bs As </td>
                                <td width="10%">$ 5186.95 </td>
