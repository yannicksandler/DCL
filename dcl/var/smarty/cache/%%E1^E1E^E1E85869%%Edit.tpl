184
a:4:{s:8:"template";a:2:{s:22:"Backend/Orden/Edit.tpl";b:1;s:28:"Backend/Orden/ColumnForm.tpl";b:1;}s:9:"timestamp";i:1411136965;s:7:"expires";i:1411136965;s:13:"cache_serials";a:0:{}}
<!-- date picker --> 
...
function guardarObtenerInsumos(insumo, action)
{
	if (insumo) // si esta seteado
	{
		...
		$.ajax({
			type: "GET",
			url: '/Orden/GetInsumos/Orden/' +  3698  + '/Insumo/' + insumo + '/Accion/' + action,
			dataType: "text/html",
...
<h1>Editar Orden de trabajo &raquo; <span>3698</span></h1>
...
<form id="FrmEdit" enctype="multipart/form-data" action="" method="post">
    <input type="hidden" name="data[Id]" value="3698" id="OrdenDeTrabajo"/>
                  ...
                  <tr>
                    ...
                    <select name="data[ClienteId]" class="required">
                        <option value="">Seleccionar</option>
                                                ...
                                                <option value="163" selected="selected">Pet Por</option>
                    ...
                    <input id="producto" type="text" class="required" name="data[Producto]" value="Dípticos">
                </div> <!-- /contentTitles --></td>
                    <td>         
                <div class="contentTitles">
                    <label class="blue">Cantidad</label>
                    <input type="text" class="number" name="data[Cantidad]" value="1000">
                </div> <!-- /contentTitles --></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
                <td><div class="contentTitles general" style="display: none">
                    <div align="center">
                      ...
                      <textarea name="data[DescripcionDeTrabajo]" cols="45" rows="5" class="required" id="descripciondetrabajo">Formato: 22x 15 cm
Material: papel ilustración 150gr
Colores: full color
Terminacion:</textarea>
                    </div>
                </div> 
                  <div align="center">
                    <!-- /contentTitles -->  
  ...
  <tr>
    <td><div class="contentTitles">
                    ...
                    <input type="text" class="required date" id="fechaInicio" name="data[FechaInicio]" value="17/09/2014">
    ...
    <td>                <div class="contentTitles">
                    ...
                    <input type="text" class="required date" id="fechaEntrega" name="data[FechaEntrega]" value="19/09/2014">
  ...
  <tr>
    <td>                <div class="contentTitles" id="">
                    ...
                    <select name="data[EstadoId]" class="required">
                        <option value="">Seleccionar</option>
                                                ...
                                                <option value="1" selected="selected">Cotizado</option>
    ...
    <td>            
                <div class="contentTitles">
                    ...
                    <input type="text" class="number" id="" name="data[TiempoEstimado]" value="45">	
                </div> <!-- /contentTitles -->
    </td>
  </tr>
</table>                
                ...
                <td>
					  ...
					  <tr>
					    <td><div class="contentTitles">
					                    ...
					                    <input type="text" class="number" id="totalSinIva" name="data[TotalSinIva]" value="">
					                </div> <!-- /contentTitles --></td>
					    <td>
					    
					    					                <div class="contInputs" >
							            <div class="buttonsCont" style="clear: left;">
											<input type="" value="Presupuestar" id=3698 presupuesto="" class="btDark Presupuestar" title="Ver el formulario para crear un presupuesto" />
							            </div>
									</div>
