159
a:4:{s:8:"template";a:1:{s:37:"Backend/OrdenPago/GetPercepciones.tpl";b:1;}s:9:"timestamp";i:1407415272;s:7:"expires";i:1407415272;s:13:"cache_serials";a:0:{}}
                ...
                <div>
                    ...
                    <div class="listItems">
                    	<table border="0" cellpadding="0" cellspacing="0" width="100%">
												    ...
												    <tr >
                                <td width="10%">2013-11-20 01:46:13 </td>
                                <td width="10%">00639521 </td>
                                <td width="10%">$ 204.75 </td>
                                <td width="10%">Percepcion IVA </td>
                                
                                <td width="10%">
                                	<a class="AgregarPagoPercepcion" pagoid="2"><img src="/images/icons/add.png" title="Agregar pago"/> Agregar percepcion</a>
                                </td>
						    </tr>
												    <tr >
                                ...
                                <td width="10%">
                                	<a class="AgregarPagoPercepcion" pagoid="39"><img src="/images/icons/add.png" title="Agregar pago"/> Agregar percepcion</a>
												    ...
												    <tr >
                                <td width="10%">2014-05-14 11:24:40 </td>
                                <td width="10%">0010195604 </td>
                                <td width="10%">$ 58.66 </td>
                                <td width="10%">Percepcion IVA </td>
                                
                                <td width="10%">
                                	<a class="AgregarPagoPercepcion" pagoid="42"><img src="/images/icons/add.png" title="Agregar pago"/> Agregar percepcion</a>
                                </td>
						    </tr>
												    <tr >
                                ...
                                <td width="10%">
                                	<a class="AgregarPagoPercepcion" pagoid="46"><img src="/images/icons/add.png" title="Agregar pago"/> Agregar percepcion</a>
												    ...
												    <tr >
                                <td width="10%">2014-06-26 12:42:40 </td>
                                <td width="10%">0010203233 </td>
                                <td width="10%">$ 117.71 </td>
                                <td width="10%">Percepcion IVA </td>
                                
                                <td width="10%">
                                	<a class="AgregarPagoPercepcion" pagoid="48"><img src="/images/icons/add.png" title="Agregar pago"/> Agregar percepcion</a>
                                </td>
						    </tr>
												    <tr >
                                ...
                                <td width="10%">
                                	<a class="AgregarPagoPercepcion" pagoid="31"><img src="/images/icons/add.png" title="Agregar pago"/> Agregar percepcion</a>
												    ...
												    <tr >
                                <td width="10%">2013-12-13 02:30:58 </td>
                                <td width="10%">0010173819 </td>
                                <td width="10%">$ 132.05 </td>
                                <td width="10%">Percepcion IVA </td>
                                
                                <td width="10%">
                                	<a class="AgregarPagoPercepcion" pagoid="5"><img src="/images/icons/add.png" title="Agregar pago"/> Agregar percepcion</a>
                                </td>
						    </tr>
												    <tr >
                                <td width="10%">2014-01-06 03:28:16 </td>
                                <td width="10%">0010178856 </td>
                                <td width="10%">$ 81.82 </td>
                                <td width="10%">Percepcion IVA </td>
                                
                                <td width="10%">
                                	<a class="AgregarPagoPercepcion" pagoid="7"><img src="/images/icons/add.png" title="Agregar pago"/> Agregar percepcion</a>
                                </td>
						    </tr>
												    <tr >
                                <td width="10%">2014-01-08 10:23:31 </td>
                                <td width="10%">0010180134 </td>
                                <td width="10%">$ 119.73 </td>
                                <td width="10%">Percepcion IVA </td>
                                
                                <td width="10%">
                                	<a class="AgregarPagoPercepcion" pagoid="9"><img src="/images/icons/add.png" title="Agregar pago"/> Agregar percepcion</a>
                                </td>
						    </tr>
												    <tr >
                                <td width="10%">2014-02-24 10:25:58 </td>
                                <td width="10%">0010185096 </td>
                                <td width="10%">$ 115.87 </td>
                                <td width="10%">Percepcion IVA </td>
                                
                                <td width="10%">
                                	<a class="AgregarPagoPercepcion" pagoid="15"><img src="/images/icons/add.png" title="Agregar pago"/> Agregar percepcion</a>
                                </td>
						    </tr>
												    <tr >
                                <td width="10%">2014-02-24 10:28:32 </td>
                                <td width="10%">0010185323 </td>
                                <td width="10%">$ 777.00 </td>
                                <td width="10%">Percepcion IVA </td>
                                
                                <td width="10%">
                                	<a class="AgregarPagoPercepcion" pagoid="17"><img src="/images/icons/add.png" title="Agregar pago"/> Agregar percepcion</a>
                                </td>
						    </tr>
												    <tr >
                                <td width="10%">2014-03-27 10:53:23 </td>
                                <td width="10%">006300015102 </td>
                                <td width="10%">$ 156.37 </td>
                                <td width="10%">Percepcion IVA </td>
                                
                                <td width="10%">
                                	<a class="AgregarPagoPercepcion" pagoid="20"><img src="/images/icons/add.png" title="Agregar pago"/> Agregar percepcion</a>
                                </td>
						    </tr>
												    <tr >
