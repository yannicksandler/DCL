156
a:4:{s:8:"template";a:1:{s:34:"Backend/BancoTipoConcepto/Edit.tpl";b:1;}s:9:"timestamp";i:1409582295;s:7:"expires";i:1409582295;s:13:"cache_serials";a:0:{}}
...
<h1>Editar concepto bancario &raquo; <span>34</span></h1>

<form id="FrmEdit" enctype="multipart/form-data" action="" method="post">
    <input type="hidden" name="data[Id]" value="34" />
        ...
        <div class="contentEditor"> <!-- formulario de edicion de contenido -->
            ...
            <div class="productsEditorContent">
                ...
                <div class="contentTitles">
                    ...
                    <input type="text" class="required" name="data[Nombre]" value="OPERACIONES EN RED LINK">
                </div> <!-- /contentTitles -->
