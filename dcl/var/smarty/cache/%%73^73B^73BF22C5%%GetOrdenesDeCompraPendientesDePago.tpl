178
a:4:{s:8:"template";a:1:{s:56:"Backend/OrdenPago/GetOrdenesDeCompraPendientesDePago.tpl";b:1;}s:9:"timestamp";i:1409774051;s:7:"expires";i:1409774051;s:13:"cache_serials";a:0:{}}
        ...
        <div class="listItems listItemsScroll">
				...
				<table border="0" cellpadding="0" cellspacing="0">
							...
							<td width="10%">
								<p class="">
										# 2358
										<img src="/images/icons/zoom_in.png" title="() - Transferencia"/>
								</p>
							</td>
							<td width="20%">
								...
								<table border="0" cellspacing="0">
								  <tr>
								    <td>
								    <p><img src="/images/icons/bullet_go.png" alt="item" title="Item"/> Routeado</p>
								    </td>
								  </tr>
								</table>
							...
							<td width="30%" align="center">
								    <input type="text" value="Importe" name="ImporteItem" id="importe_2358" class="importe"/>
								    <a class="AgregarOrdenDeCompra" id="2358"
