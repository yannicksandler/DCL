...
<table width="80%"  border="0">
  ...
  <tr>
    <td>&nbsp;</td>
    <td></td>
    <td><strong>Fecha</strong>: {$OrdenDeCompra.Fecha}</td>
  </tr>
  <tr>
    <td><strong>Orden de compra Nro</strong>: # {$OrdenDeCompra.Id}</td>
    <td></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td><strong>Proveedor</strong>: {$OrdenDeCompra.NombreProveedor}</td>
    <td></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
