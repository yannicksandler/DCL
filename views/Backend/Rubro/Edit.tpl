...
<h1>{if $data.Id}Editar{else}Nuevo{/if} rubro &raquo; <span>{$data.Id}</span></h1>
            ...
            <div class="productsEditorContent">
                ...
                <div class="contentTitles" id="">
                    ...
                    <select name="data[TipoEntidad]" class="required">
                        ...
                        <option value="CLI" {if $data.TipoEntidad=="CLI"}selected="selected"{/if}>Cliente</option>
                        <option value="PRO" {if $data.TipoEntidad=="PRO"}selected="selected"{/if}>Proveedor</option>
                    </select>
                </div> <!-- /contentTitles -->
