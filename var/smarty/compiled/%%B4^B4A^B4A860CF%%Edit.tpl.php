<?php /* Smarty version 2.6.26, created on 2016-04-20 04:11:40
         compiled from Backend/NotaCredito/Edit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'Backend/NotaCredito/Edit.tpl', 39, false),)), $this); ?>
...
<a class="linkSendHome linkSendHomeEdit" href="/NotaCredito/List/order/Fecha_DESC"><img src="/images/icons/arrow_undo.png" title="Volver al listado"/> Volver al listado de notas de credito &raquo; </a>

<h1><?php if ($this->_tpl_vars['data']['Id']): ?>Editar<?php else: ?>Nueva<?php endif; ?> Nota de credito &raquo; <span><?php echo $this->_tpl_vars['data']['Numero']; ?>
...
$this->_smarty_include(array('smarty_include_tpl_file' => "Backend/NotaCredito/ColumnForm.tpl", 'smarty_include_vars' => array()));
        ...
        <div class="contentEditor"> <!-- formulario de edicion de contenido -->
            ...
            <div class="productsEditorContent">
                		...
                		<div class="buttonsCont" style="clear: left;">
							...
							<input type="" value="Imprimir" href="/NotaCredito/NotaCreditoView/id/<?php echo $this->_tpl_vars['data']['Id']; ?>
" class="btDark printCredito" title="Imprimir nota de credito" />
							<?php endif; ?>
...
" <?php if ($this->_tpl_vars['data']['Id']): ?>readonly="readonly" disabled<?php endif; ?>>
                ...
                <div class="contentTitles">
                    ...
                    <textarea name="data[Descripcion]" cols="45" rows="5" class="required" id="Descripcion" <?php if ($this->_tpl_vars['data']['Id']): ?>readonly="readonly" disabled<?php endif; ?>><?php echo $this->_tpl_vars['data']['Descripcion']; ?>
</textarea>
                </div> <!-- /contentTitles -->
