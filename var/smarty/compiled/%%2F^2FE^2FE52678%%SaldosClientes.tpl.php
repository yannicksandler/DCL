<?php /* Smarty version 2.6.26, created on 2016-04-21 07:32:06
         compiled from Backend/GestionEconomica/SaldosClientes.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'Backend/GestionEconomica/SaldosClientes.tpl', 197, false),)), $this); ?>
<?php echo '
...
<h1>Saldos total clientes ($ <?php echo $this->_tpl_vars['SaldoTotalClientes']; ?>
)</h1>
	...
	<div class="list">
        ...
        <div class="listItems listItemsScroll">
				...
				<table id="my-table" style="border-collapse:collapse" border="0" cellpadding="0" cellspacing="0">
					...
					<?php if (! count($this->_tpl_vars['Clientes'])): ?>
...
?>
						<tr>
							...
							<td width="10%" align="center">
								...
								<a class="popup" 
									    href="/CuentaCorriente/ListCliente/ClienteId/<?php echo $this->_tpl_vars['pen']['Id']; ?>
"
