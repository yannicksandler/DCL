<?php /* Smarty version 2.6.26, created on 2015-01-12 11:40:50
         compiled from Backend/Rubro/Edit.tpl */ ?>
...
<h1><?php if ($this->_tpl_vars['data']['Id']): ?>Editar<?php else: ?>Nuevo<?php endif; ?> rubro &raquo; <span><?php echo $this->_tpl_vars['data']['Id']; ?>
</span></h1>
...
">
                ...
                <div class="contentTitles" id="">
                    ...
                    <select name="data[TipoEntidad]" class="required">
                        ...
                        <option value="CLI" <?php if ($this->_tpl_vars['data']['TipoEntidad'] == 'CLI'): ?>selected="selected"<?php endif; ?>>Cliente</option>
                        <option value="PRO" <?php if ($this->_tpl_vars['data']['TipoEntidad'] == 'PRO'): ?>selected="selected"<?php endif; ?>>Proveedor</option>
                    </select>
                </div> <!-- /contentTitles -->
