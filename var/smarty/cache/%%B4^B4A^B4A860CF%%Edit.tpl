196
a:4:{s:8:"template";a:2:{s:28:"Backend/NotaCredito/Edit.tpl";b:1;s:34:"Backend/NotaCredito/ColumnForm.tpl";b:1;}s:9:"timestamp";i:1461136300;s:7:"expires";i:1461136300;s:13:"cache_serials";a:0:{}}
<!-- date picker -->
...
<h1>Nueva Nota de credito &raquo; <span> (Interno )</span></h1>
        ...
        <div class="contentEditor"> <!-- formulario de edicion de contenido -->
            ...
            <div class="productsEditorContent">
                ...
                <div class="contentTitles" id="">
						...
						<input id="cliente_autocomplete" value="" />
                ...
                <div class="contentTitles">
                    ...
                    <input type="text" class="date required" id="Fecha" name="data[Fecha]" value="" >
                </div> <!-- /contentTitles -->
                
                <div class="contentTitles">
                    <label class="blue">Detalle</label>
                    <textarea name="data[Descripcion]" cols="45" rows="5" class="required" id="Descripcion" ></textarea>
                </div> <!-- /contentTitles -->
                
                <div class="contentTitles">
                    <label class="blue">Importe</label>
                    <input type="text" class="number required" id="" name="data[Importe]" value="" >
                </div> <!-- /contentTitles -->
