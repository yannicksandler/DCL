232
a:4:{s:8:"template";a:3:{s:23:"Backend/Insumo/Edit.tpl";b:1;s:34:"Backend/Layouts/Include/Header.tpl";b:1;s:29:"Backend/Insumo/ColumnForm.tpl";b:1;}s:9:"timestamp";i:1462461663;s:7:"expires";i:1462461663;s:13:"cache_serials";a:0:{}}<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<h1>Editar  insumo para orden de trabajo #3972</h1>


<form id="FrmEdit" enctype="multipart/form-data" action="" method="post">
    <input type="hidden" name="data[Id]" value="4979" />
    <input type="hidden" name="data[OrdenId]" value="3972" />
    <input type="hidden" name="data[EsFlete]" value="NO" />
    <input type="hidden" name="data[EsManoDeObra]" value="NO" />
  ...
  <tr>
    <td>
				<div class="contentTitles">
                    <ul class="statsList">
			                        <li>
			                            <p class="big">Exhibidor grande</p>
			                        </li>
			                    </ul> <!-- /statsList -->
                </div> <!-- /contentTitles -->
    ...
    <td>
                <div class="contentTitles" >
                    <p>Formato: 170 cm x 48 cm x 36 cm<br />
Caño 40/20<br />
MDF 15mm<br />
Acrílico cristal 4 mm<br />
Perfilería: aluminio<br />
Cerradura + bisagras + 4 ruedas<br />
Terminacion: pintados con logo de la marca de producto en vinilo de corte</p>
                </div> <!-- /contentTitles -->
  ...
  <tr>
    <td>
				<div class="contentTitles">
                    ...
                    <input type="text" class="required" id="nombre" name="data[Nombre]" value="Confeccion de exhibidor">
                </div> <!-- /contentTitles -->
                ...
                <div class="contentTitles" >
                    ...
                    <select name="data[ProveedorId]" class="required" id="select_proveedor">
                        <option value="">Seleccionar</option>
                                                <option value="346" >A3 creaciones</option>
                                                ...
                                                <option value="149" >Adriana Moscovich - ALQUILER OFICINA</option>
                                                ...
                                                <option value="347" >Ana Uran</option>
                                                <option value="344" >Anabella Chonev</option>
                                                <option value="90" >Andres Oliveto</option>
                                                <option value="214" >APF</option>
                                                <option value="358" >Argentina embalajes</option>
                                                ...
                                                <option value="330" >Autopistas del sol</option>
                                                ...
                                                <option value="348" >Cablevision</option>
                                                <option value="145" >CAJA CHICA</option>
                                                <option value="4" >Calcos Closas</option>
                                                <option value="364" >CARAVAJAL CARINA ROXANA</option>
                                                ...
                                                <option value="353" >Club de la impresion</option>
                                                <option value="13" >CMYB</option>
                                                <option value="253" >Co Print</option>
                                                <option value="335" >ColorArt</option>
                                                <option value="342" >Colorgraf</option>
                                                ...
                                                <option value="359" >Escribania Kirzner</option>
                                                ...
                                                <option value="329" >Importadora al costo sa</option>
                                                ...
                                                <option value="366" >JR. TRANS</option>
                                                ...
                                                <option value="331" >las rocas</option>
                                                <option value="350" >Las Vegas</option>
                                                ...
                                                <option value="338" >Metalurgica metalia srl</option>
                                                ...
                                                <option value="341" selected="selected">Obra-Completa</option>
                                                ...
                                                <option value="336" >Pardo cecilia ines</option>
                                                <option value="351" >PC Retail</option>
                                                <option value="111" >PCTronix</option>
                                                <option value="356" >PICO LAURA EDITH</option>
                                                ...
                                                <option value="345" >Polar Center</option>
                                                ...
                                                <option value="340" >Sancor Seguros</option>
                                                ...
                                                <option value="365" >SUSS DCL GROUP SRL</option>
                                                ...
                                                <option value="354" >TECPLAS</option>
                                                <option value="154" >TELECENTRO</option>
                                                <option value="173" >Telecom</option>
                                                <option value="352" >Ticket band</option>
                                                <option value="264" >todo cuadernos</option>
                                                <option value="332" >Todo Planograf  Srl</option>
                                                <option value="161" >Todomicro</option>
                                                <option value="258" >Todoplastic</option>
                                                <option value="355" >Tomasco</option>
                                                <option value="360" >ToolBox Impresiones 3D</option>
                                                ...
                                                <option value="337" >Zonenfeld Pablo Javier</option>
                                            </select>
                </div> <!-- /contentTitles -->
  ...
  <tr>
    <td>&nbsp;
				<div class="contentTitles">
                    ...
                    <input type="text" class="required number" id="" name="data[PrecioUnitarioSinIVA]" value="7200.000">
                </div> <!-- /contentTitles -->            
    ...
    <td>&nbsp;
                <div class="contentTitles">
                    ...
                    <input type="text" class="required number" id="" name="data[Cantidad]" value="30.00">
                </div> <!-- /contentTitles -->
    
    </td>
    <td>
				<div class="contentTitles">
                    <label class="blue">Importe total: $216000</label>
                </div> <!-- /contentTitles -->
  ...
  <tr>
    <td>&nbsp;
                <div class="contentTitles">
                    ...
                    <input type="text" class="required number" id="" name="data[PlazoDeEntrega]" value="45">
                </div> <!-- /contentTitles -->
  ...
  <tr>
    <td>&nbsp;
                <div class="contentTitles">
                    ...
                    <input type="text" class="" id="" name="data[LugarDeEntrega]" value="a convenir">
                </div> <!-- /contentTitles -->
  ...
  <tr>
    <td>&nbsp;
		<div class="contentTitles">
                    ...
                    <input class="check required" type="radio" name="data[Elegido]" value="SI" />
                    <label class="check blue">Si</label>
                    <input class="check required" type="radio" name="data[Elegido]" value="NO" checked="checked"/>
    ...
    <td>&nbsp;
				<div class="contentTitles">
                    ...
                    <input type="text" class="" id="" name="data[FormaDePago]" value="Anticipo 50% y saldo contra entrega ">
                </div> <!-- /contentTitles -->    
    </td>
  </tr>
</table>
