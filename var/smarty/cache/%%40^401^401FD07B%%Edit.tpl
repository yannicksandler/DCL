252
a:4:{s:8:"template";a:3:{s:26:"Backend/OrdenPago/Edit.tpl";b:1;s:32:"Backend/OrdenPago/ColumnForm.tpl";b:1;s:48:"Backend/OrdenPago/FacturasDeCompraLiquidadas.tpl";b:1;}s:9:"timestamp";i:1462288231;s:7:"expires";i:1462288231;s:13:"cache_serials";a:0:{}}
<!-- date picker -->
...
$(document).ready(function(){
    ...
    $('#FechaAnulacion').datepicker({
        ...
        dateFormat: 'dd/mm/yy'
        	...
        	//GetLiquidacion('list', 2627);
    	//GetFacturasDeCompraLiquidadas();
    	//GetOrdenesDeCompraAgregadas(2627);
    	GetPagos('list', 2627);
...
<h1>Editar orden de pago &raquo; <span>1000557 (Interno 2627)</span></h1>

		        
         <input type="reset" value="Imprimir" id="2627" class="btDark PrintOrdenDePago" title="Buscar" />
        
<form id="FrmEdit" enctype="multipart/form-data" action="" method="post">
    <input type="hidden" id="OrdenDePagoId" name="data[Id]" value="2627" />
    <input type="hidden" name="data[Fecha]" value="03/05/2016" />
                 ...
                 <div class="filtersBox filtersInfoBox">
	                ...
	                <ul>
	                    <li>
							...
							<input id="proveedor_autocomplete" value="Maytok" readonly="readonly" disabled/>
							<!-- no usado 
							<input type="hidden" value="32" id="ProveedorId"></input>
							 -->
	                        ...
	                        <option value="">Seleccionar</option>
	                        	                        ...
	                        	                        <option value="32" selected="selected">Maytok</option>
	                        	                        ...
	                        	                        <option value="341" >Obra-Completa</option>
                    	...
                    	<li>
		                    ...
		                    <input class="check SetTipoCobranza" id="TipoN" type="radio" name="Tipo" value="N" checked="checked" readonly="readonly" disabled/>
		                    
                    	</li>
	                    <li>
	                	    <label class="blue"><img src="/images/icons/error.png" title="Importe "/> Importe liquidado</label>       
							 
							<input type="hidden" class="required number" readonly="readonly" disabled id="ImporteTotalLiquidadoInput" name="data[ImporteLiquidado]" value="1400">
							
							<div id="ImporteTotalLiquidado"><label>$ 1400</label></div>
	                    </li>
	                    <li>
						...
						<input type="hidden" class="required number" readonly="readonly" disabled id="ImporteRestanteInput" name="data[ImporteRestante]" value="1400">
                    	...
                    	<li>
							...
							<div id=""><label>10070.00</label></div>
...
<h2>Cantidad: 1</h2>
        ...
        <div class="listItems listItemsScroll">
                ...
                <div class="contentTitles">
                    <input type="hidden" id="" class="number" name="data[Importe]" value="1400.00">
                </div> <!-- /contentTitles -->
