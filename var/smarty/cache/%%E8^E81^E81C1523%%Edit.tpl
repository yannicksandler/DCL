188
a:4:{s:8:"template";a:2:{s:24:"Backend/Cliente/Edit.tpl";b:1;s:30:"Backend/Cliente/ColumnForm.tpl";b:1;}s:9:"timestamp";i:1462461347;s:7:"expires";i:1462461347;s:13:"cache_serials";a:0:{}}
...
<h1>Editar Cliente &raquo; <span>184</span></h1>

<form id="FrmEdit" enctype="multipart/form-data" action="" method="post">
    <input type="hidden" name="data[Id]" value="184" />
        ...
        <div class="contentEditor"> <!-- formulario de edicion de contenido -->
            ...
            <div class="productsEditorContent">
                ...
                <div class="contentTitles">
                    ...
                    <input type="text" class="required" name="data[Nombre]" value="Watch Land">
                </div> <!-- /contentTitles -->
                                         
                <div class="contentTitles">
                    <label class="blue">Razon social</label>
                    <input type="text" class="required" name="data[RazonSocial]" value="Watch Land">
                </div> <!-- /contentTitles -->
                ...
                <div class="contentTitles" id="">
                    ...
                    <select name="data[RubroId]" class="required">
                        <option value="">Seleccionar</option>
                                                ...
                                                <option value="13" selected="selected">Comercio</option>
                ...
                <div class="contentTitles">
                    ...
                    <input type="text" class="email" name="data[PersonaEmail]" value="marketing@watch-land.com.ar">
                </div> <!-- /contentTitles -->

                <div class="contentTitles">
                    <label class="blue">Persona Telefono</label>
                    <input type="text" class="" name="data[PersonaTelefono]" value="48573834">
                </div> <!-- /contentTitles -->

                <div class="contentTitles">
                    <label class="blue">Rubro</label>
                    <input type="text" class="" name="data[Rubro]" value="18">
                </div> <!-- /contentTitles -->
				
                <div class="contentTitles">
                    <label class="blue">Cuit</label>
                    <input type="text" class="number" name="data[Cuit]" value="30555555555">
                </div> <!-- /contentTitles -->                       
                ...
                <div class="contentTitles">
                    ...
                    <input type="text" class="" name="data[Telefono]" value="">
                </div> <!-- /contentTitles -->
