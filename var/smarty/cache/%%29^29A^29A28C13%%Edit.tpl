215
a:4:{s:8:"template";a:2:{s:30:"Backend/FacturaCompra/Edit.tpl";b:1;s:51:"Backend/FacturaCompra/OrdenesDeCompraLiquidadas.tpl";b:1;}s:9:"timestamp";i:1462276411;s:7:"expires";i:1462276411;s:13:"cache_serials";a:0:{}}
<!-- date picker -->
...
<form id="FrmEdit" enctype="multipart/form-data" action="" method="post">
    ...
    <input type="hidden" name="" value="1" id="ProveedorTipoIva"/>  
    ...
    <div class="form">
        ...
        <div id="mensajes">
                    <p class="success" style="width:61%;">Factura #001000000236 creada correctamente. <img src="/images/icons/tick.png" /></p>
                </div>
            ...
            <div class="filtersBox filtersInfoBox">
                ...
                <ul>
                    <li>
                	    ...
                	    <input id="proveedor_autocomplete" class="required" name="data[ProveedorNombre]" value="Marroquineria Alberto A" readonly="readonly" disabled/>       
	                    <select name="data[ProveedorId]" class="required CambiarProveedor" id="SeleccionarProveedor">
	                        <option value="">Seleccionar</option>
	                        	                        ...
	                        	                        <option value="268" selected="selected">Marroquineria Alberto A</option>
                    ...
                    <li>
						...
						<input class="required number" type="text" name="data[Numero]" id="" value="001000000236" readonly="readonly"/>
