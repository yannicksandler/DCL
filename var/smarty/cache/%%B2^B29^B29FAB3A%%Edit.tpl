144
a:4:{s:8:"template";a:1:{s:22:"Backend/Banco/Edit.tpl";b:1;}s:9:"timestamp";i:1461845415;s:7:"expires";i:1461845415;s:13:"cache_serials";a:0:{}}
...
<h1>Editar Banco &raquo; <span>22</span></h1>

<form id="FrmEdit" enctype="multipart/form-data" action="" method="post">
    <input type="hidden" name="data[Id]" value="22" />
        ...
        <div class="contentEditor"> <!-- formulario de edicion de contenido -->
            ...
            <div class="productsEditorContent">
                ...
                <div class="contentTitles">
                    ...
                    <input type="text" class="number" name="data[NumeroDeCuenta]" value="05280210308263">
                </div> <!-- /contentTitles -->
                
                <div class="contentTitles">
                    <label class="blue">Saldo</label>
                    <input type="text" class="number" name="data[SaldoCuenta]" value="12174.07">
                </div> <!-- /contentTitles -->
                
                <div class="contentTitles">
                    <label class="blue">Ultimo numero de cheque emitido</label>
                    <input type="text" class="number" name="data[UltimoNumeroCheque]" value="82641450">
                </div> <!-- /contentTitles -->
