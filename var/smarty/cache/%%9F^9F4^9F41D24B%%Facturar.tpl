154
a:4:{s:8:"template";a:1:{s:32:"Backend/Facturacion/Facturar.tpl";b:1;}s:9:"timestamp";i:1461678372;s:7:"expires";i:1461678372;s:13:"cache_serials";a:0:{}}
<!-- date picker -->
...
<h2>Debe seleccionar el cliente, la fecha de factura y las ordenes que desea facturar. Opcionalmente un comentario e importe</h2>
		<input type="hidden" value="2000004" id="FacturaId"></input>        
...
<form id="FrmEdit" enctype="multipart/form-data" action="" method="post">
    ...
    <input type="hidden" name="" value="180" id="ClienteIdGet"/>  
    ...
    <div class="form">
        ...
        <div id="mensajes">
                    <p class="success" style="width:61%;">26/04/2016: Factura #2000004 creada correctamente. <img src="/images/icons/tick.png" /></p>
            ...
            <div class="filtersBox filtersInfoBox">
                ...
                <ul>
                    <li>
	                    ...
	                    <select name="ClienteId" class="required CambiarCliente" id="SeleccionarCliente">
	                        <option value="">Seleccionar</option>
	                        	                        ...
	                        	                        <option value="180" selected="selected">Zanella</option>
                    ...
                    <li>
						...
						<input class="required date" type="text" name="FechaFactura" id="FechaFactura" value="26/04/2016" />
                    ...
                    <li>
						...
						<input class="required date" type="text" name="data[FechaPosibleDeCobro]" id="FechaPosibleDeCobro" value="29/04/2016" />
                    ...
                    <li>
                        ...
                        <option value="">Seleccionar</option>
                                                ...
                                                <option value="3" selected="selected">Consumidor final - --21.00 - (Tipo factura: B)</option>
