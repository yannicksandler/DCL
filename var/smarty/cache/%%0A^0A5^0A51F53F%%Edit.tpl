194
a:4:{s:8:"template";a:2:{s:27:"Backend/NotaDebito/Edit.tpl";b:1;s:33:"Backend/NotaDebito/ColumnForm.tpl";b:1;}s:9:"timestamp";i:1461136513;s:7:"expires";i:1461136513;s:13:"cache_serials";a:0:{}}
<!-- date picker -->
...
<h1>Nueva Nota de debito &raquo; <span> (Interno )</span></h1>
        ...
        <div class="contentEditor"> <!-- formulario de edicion de contenido -->
            ...
            <div class="productsEditorContent">
                ...
                <div class="contentTitles">
                    ...
                    <textarea name="data[Comentario]" cols="45" rows="5" class="required" id="Descripcion" ></textarea>
                </div> <!-- /contentTitles -->
                
                <div class="contentTitles">
                    <label class="blue">Importe de rechazo sin IVA</label>
                    <input type="text" class="number required" id="" name="data[ImporteRechazo]" value="" >
                </div> <!-- /contentTitles -->
