192
a:4:{s:8:"template";a:2:{s:26:"Backend/Proveedor/Edit.tpl";b:1;s:32:"Backend/Proveedor/ColumnForm.tpl";b:1;}s:9:"timestamp";i:1462456257;s:7:"expires";i:1462456257;s:13:"cache_serials";a:0:{}}
...
<h1>Editar Proveedor &raquo; <span>341</span></h1>

<form id="FrmEdit" enctype="multipart/form-data" action="" method="post">
    <input type="hidden" name="data[Id]" value="341" />
        ...
        <div class="contentEditor"> <!-- formulario de edicion de contenido -->
            ...
            <div class="productsEditorContent">
                ...
                <div class="contentTitles">
                    ...
                    <input type="text" class="required" name="data[Nombre]" value="Obra-Completa">
                </div> <!-- /contentTitles -->
                         
                <div class="contentTitles">
                    <label class="blue">Razon social</label>
                    <input type="text" class="" name="data[RazonSocial]" value="Celia Jara">
                </div> <!-- /contentTitles -->
                ...
                <div class="contentTitles" id="">
                    ...
                    <select name="data[TipoGastoId]" class="required">
                        <option value="">Seleccionar</option>
                                                ...
                                                <option value="3" selected="selected">Insumos</option>
                ...
                <div class="contentTitles">
                    ...
                    <input type="text" class="" name="data[PersonaContacto]" value="Juan jara">
                </div> <!-- /contentTitles -->

                <div class="contentTitles">
                    <label class="blue">Email de persona de contacto</label>
                    <input type="text" class="email" name="data[PersonaEmail]" value="info@obra-completa.com.ar">
                </div> <!-- /contentTitles -->

                <div class="contentTitles">
                    <label class="blue">Persona Telefono</label>
                    <input type="text" class="" name="data[PersonaTelefono]" value="1535486344">
                </div> <!-- /contentTitles -->

                <div class="contentTitles">
                    <label class="blue">Cuit</label>
                    <input type="text" class="number" name="data[Cuit]" value="27261288643">
                </div> <!-- /contentTitles -->                       
                ...
                <div class="contentTitles">
                    ...
                    <textarea name="data[Direccion]" cols="45" rows="5">Paysandu 1944
</textarea>
                </div> <!-- /contentTitles -->
                ...
                <div class="contentTitles">
                    ...
                    <input type="text" class="" name="data[Telefono]" value="45813137">
                </div> <!-- /contentTitles -->
