 ...
 * @property Doctrine_Collection $OrdenesDePago
 ...
 */
abstract class BaseProveedor extends Doctrine_Record
{
    public function setTableDefinition()
    {
        ...
        $this->index('fk_Proveedor_Rubro', array(
             'fields' => 
             array(
              0 => 'RubroId',
             ),
             ));
        $this->index('fk_Proveedor_TipoIva', array(
             'fields' => 
             array(
              0 => 'TipoIvaId',
             ),
    ...
    public function setUp()
    {
        ...
        $this->hasMany('OrdenDePago as OrdenesDePago', array(
             'local' => 'Id',
             'foreign' => 'ProveedorId'));
