 ...
 */
abstract class BaseOrdenDePagoFacturaCompra extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('orden_de_pago_factura_compra');
        ...
        $this->index('fk_orden_de_pago_factura_compra', array(
             'fields' => 
             array(
              0 => 'OrdenDePagoId',
             ),
