...
class OrdenDePago extends BaseOrdenDePago
{
    ...
    */
    ...
    public function GetTextDetalleLiquidacionHtmlConLinkPopUp()
    {
    	$facturasCompra	=	$this->GetFacturasDeCompraLiquidadas(); //OrdenDePagoFacturaCompra
    	$ordenesDeCompra	=	$this->GetLiquidacionOrdenesDeCompra(); //OrdenDePagoOrdenDeCompra
    	...
    	foreach($facturasCompra as $f)
    	{
    		$link = '/FacturaCompra/Edit/FacturaNumero/'.$f->FacturaNumero.'/ProveedorId/'.$f->ProveedorId.'/TipoIvaId/'.$f->TipoIvaId;
    		//$detalle	=	$detalle . 'FC '. $f->FacturaNumero . ' ( $'. $f->ImporteLiquidado .' )<br>';
    		$detalle = "<a class=\"popup\" href=\"".$link."\">FC ".$f->FacturaNumero.' ( $'. $f->ImporteLiquidado." )"."</a>";
    	}
    	...
    	foreach($ordenesDeCompra as $oc)
    	{
    		...
    		$link	=	'/OrdenCompra/Edit/id/'.$oc->OrdenDeCompraId;
    		 
    		$detalle = "<a class=\"popup\" href=\"".$link."\">OC ".$oc->OrdenDeCompraId.' ( $'. $oc->ImporteAbonado." )"."</a>";
    	}
