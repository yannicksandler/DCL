...
class Cliente extends BaseCliente
{
	...
	public function CrearCobranza($data)
	{
		...
		if($s->GetTotalPagosLiquidadosCobranza() <= 0)
			throw new Exception('Debe agregar detalle de cobro');
		...
		if(
			...
			throw new Exception('Debe coincidir el importe liquidado con el detalle de cobro');
		
		// SIN IMPLEMENTAR 2/6/2014
