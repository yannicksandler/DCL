...
class OrdenDeCompra extends BaseOrdenDeCompra
{
    ...
    {
    	//$i		= Doctrine::getTable('Insumo')->FindOneByOrdenDeCompraId( $this->Id );
    	$q	=	Doctrine_Query::create()
    	->from('Insumo i')
    	->andWhere('i.OrdenDeCompraId = ?', $this->Id)
    	->limit(1);
    ...
    */
    ...
    {
    	$Proveedor		= Doctrine::getTable('Proveedor')->FindOneById( $this->ProveedorId );
